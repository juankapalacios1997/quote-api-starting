const quotes = [
  ...
  {
    quote: 'If it was shared on Facebook or Twitter, then it must be true.',
    person: 'Confucius'
  },
  {
    quote: 'Anything is a dildo if you are brave enough.',
    person: 'Abraham Lincoln'
  },
  {
    quote: 'I can fit two fingers in my urethra.',
    person: 'Daniel Radcliff'
  },
  {
    quote: 'I you need someone to talk to, you know where to find me.',
    person: 'Wally'
  },
  {
    quote: 'I never said half the crap people say I did.',
    person: 'Albert Einsten'
  },
  {
    quote: 'Give her the D.',
  ...
  {
    quote: 'I am so tired that if you told me to eat pussy, I would still eat pussy... but tired.',
    person: 'George W. Bush'
  },
  {
    quote: 'I don´t want to sound racist, but....',
    person: 'Adolf Hitler'
  },
  {
    quote: 'I someone disagrees with you, just punch ´em in the throat',
